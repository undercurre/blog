...
```
npm set-script prettier "prettier --write ./miniprogram/**/*.{vue,ts,tsx,js,jsx,css,less,scss,json,md}"
```
...
```js
module.exports = {
  extends: ["stylelint-config-standard", "stylelint-config-wxss"],
  ignoreFiles: [
    "**/*.js",
    "**/*.jsx",
    "**/*.tsx",
...
```
"stylelint": "stylelint \"./miniprogram/**/**/*.{wxss}\" --fix"
```
